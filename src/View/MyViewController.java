    ...
    public void mouseMove(MouseEvent mouseEvent){
        if (maze != null) {
            ...
            if(y_Pos < viewModel.getRowChar()){
                viewModel.moveCharacter(KeyCode.NUMPAD8); //UP
            }
            else if(y_Pos > viewModel.getRowChar()+1){
                viewModel.moveCharacter(KeyCode.NUMPAD2); //DOWN
            }
            else if(x_Pos > viewModel.getColChar()+1){
                viewModel.moveCharacter(KeyCode.NUMPAD6); //RIGHT
            }
            else if(x_Pos < viewModel.getColChar()){
                viewModel.moveCharacter(KeyCode.NUMPAD4); //LEFT
            }
        }
    }
